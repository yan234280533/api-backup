...
deepcopy-gen \
  --go-header-file hack/boilerplate/boilerplate.go.txt \
  --input-dirs=github.com/gocrane-io/api/envision/v1alpha1 \
  --output-package=github.com/gocrane-io/api/envision/v1alpha1 \
  --output-file-base=zz_generated.deepcopy
...
client-gen \
  --go-header-file hack/boilerplate/boilerplate.go.txt \
  --input-base="" \
  --input=github.com/gocrane-io/api/prediction/v1alpha1,github.com/gocrane-io/api/envision/v1alpha1 \
...
lister-gen \
  --go-header-file hack/boilerplate/boilerplate.go.txt \
  --input-dirs=github.com/gocrane-io/api/prediction/v1alpha1,github.com/gocrane-io/api/envision/v1alpha1 \
